...
import antenarightfiled from '../../images/antenarightfilled.png'
...
const G6Image9 = () => {
    ...
    return (
        <PanGestureHandler onGestureEvent={gestureHandler}>
            <Animated.Image source={antenarightfiled} style={[{ transform: [{ translateX: translateX }, { translateY: translateY }], position: 'absolute', right: 100, top: 270, width: windowWidth * (17 / 800), height: windowHeight * (23 / 360), resizeMode: 'contain' }]} />     
        </PanGestureHandler>
    )
}

export default G6Image9;