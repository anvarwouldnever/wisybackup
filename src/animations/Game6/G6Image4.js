...
import butthead from '../../images/butthead.png'
...
const G6Image4 = () => {
    ...
    return (
        <PanGestureHandler onGestureEvent={gestureHandler}>
            <Animated.Image source={butthead} style={[{ transform: [{ translateX: translateX }, { translateY: translateY }], position: 'absolute', right: 240, top: 150, width: windowWidth * (38 / 800), height: windowHeight * (38 / 360), resizeMode: 'contain' }]} />     
        </PanGestureHandler>
    )
}

export default G6Image4;