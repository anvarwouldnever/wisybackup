...
import rightoval from '../../images/rightoval.png'
...
const G6Image8 = () => {
    ...
    return (
        <PanGestureHandler onGestureEvent={gestureHandler}>
            <Animated.Image source={rightoval} style={[{ transform: [{ translateX: translateX }, { translateY: translateY }], position: 'absolute', right: 130, top: 270, width: windowWidth * (31 / 800), height: windowHeight * (25 / 360), resizeMode: 'contain' }]} />     
        </PanGestureHandler>
    )
}

export default G6Image8;