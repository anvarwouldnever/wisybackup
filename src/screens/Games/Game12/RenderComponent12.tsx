...
const RenderGame12Component = ({ data, lock, setId, id, answer, voiceForTask }) => {
    ...
    return (
        <Animated.View entering={ZoomInEasyDown} style={{width: windowWidth * (440 / 800), height: 'auto', flexDirection: 'column',  gap: windowWidth * (24 / 800), justifyContent: 'flex-start'}}>
