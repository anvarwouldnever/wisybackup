...
const RenderComponent = ({ animal, isAnimalSvg, answer, setId, id, lock, data, voice }) => {
    ...
    return (
        <Animated.View entering={ZoomInEasyDown} style={{ width: windowWidth * (392 / 800), height: Platform.isPad ? windowWidth * (360 / 800) : windowHeight * (280 / 360), flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center', alignSelf: 'center'}}>
