...
const ProgressAnimation = ({ level, task }) => {
    ...
    return (
        <View style={{width: 'auto', height: Platform.isPad? windowWidth * (28 / 800) : windowHeight * (28 / 360), position: 'absolute', right: windowWidth * (30 / 800), top: windowHeight * (25 / 360), alignItems: 'center', justifyContent: 'center', flexDirection: 'row', shadowColor: "#D0D0D0", shadowOffset: { width: 0, height: 0 }, shadowOpacity: 1, shadowRadius: 4}}>
            ...
            <Image source={star} style={{width: windowWidth * (28 / 800), height: Platform.isPad? windowWidth * (20 / 800) : windowHeight * (30 / 360), alignSelf: 'center', marginLeft: -windowWidth * (8 / 800)}} resizeMode='contain' />
        </View>
    )
}
