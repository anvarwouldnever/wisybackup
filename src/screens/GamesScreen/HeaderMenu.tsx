...
const HeaderMenu = ({ setMarketCollections, setAnimationStart, subCollections, marketCollections }) => {
        ...
        return (
            <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#F8F8F8', borderRadius: 100, padding: 8, width: Platform.isPad? windowWidth * (184 / 1194) : windowWidth * (100 / 800), height: Platform.isPad? windowWidth * (104 / 1194) : windowHeight * (56 / 360), position: 'absolute', top: windowHeight * (16 / 360), left: windowWidth * (320 / 800)}}>
                ...
                }} style={{borderRadius: 100, backgroundColor: marketCollections === null? '#504297' : '', justifyContent: 'center', alignItems: 'center', width: Platform.isPad? windowWidth * (72 / 1194) : windowWidth * (40 / 800), height: Platform.isPad? windowWidth * (68 / 1194) : windowHeight * (40 / 360), borderColor: 'black'}}>
                ...
                <TouchableOpacity onPress={() => {
                    setAnimationStart(false)
                    setMarketCollections(!null)
                }} style={{justifyContent: 'center', backgroundColor: marketCollections === null? '' : '#504297', alignItems: 'center', borderRadius: 100, width: Platform.isPad? windowWidth * (72 / 1194) : windowWidth * (40 / 800), height: Platform.isPad? windowHeight * (68 / 834) : windowHeight * (40 / 360),}}>
