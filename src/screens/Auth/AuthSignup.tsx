...
const AuthSignup = ({ proceed, toggleOption }) => {
    ...
    return (
        <Animated.View style={{justifyContent: 'space-between', marginTop: 30, alignSelf: 'center', width: width * 0.8666, height: height * 0.7725}}>
                ...
                <TouchableOpacity disabled={!email || !password || password?.length < 8} onPress={() => signUp()} style={{justifyContent: 'center', alignItems: 'center', opacity: email != '' && password != '' && password?.length >= 8? 1 : 0.5, alignSelf: 'center', width: width * 0.8666, height: height * (56 / 800), backgroundColor: '#504297', borderRadius: 100, }}>
