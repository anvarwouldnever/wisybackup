...
const Knowledge = ({ screen }) => {
    ...
    const renderItem = ({ item }) => {
        ...
        return (
            <TouchableOpacity onPress={() => navigation.navigate('ParentsSegments', {screen: item})} style={{width: windowWidth * (312 / 360), height: windowHeight * (76 / 800), borderRadius: 10, padding: windowWidth * (16 / 360), backgroundColor: '#F8F8F8', flexDirection: 'row', gap: windowWidth * (16 / 360), alignItems: 'center'}}>
